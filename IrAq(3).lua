...
DevAli:set(IrAq.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevAli:sadd(IrAq.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevAli:set(IrAq.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevAli:sadd(IrAq.."List:Cmd:Group:New"..msg.chat_id_,"#")
