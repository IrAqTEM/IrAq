...
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevAli:set(WaTaN2.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevAli:sadd(WaTaN2.."List:Cmd:Group:New"..msg.chat_id_,"#")
send(msg.chat_id_, msg.id_,"✯︙تم ترتيب الاوامر بالشكل التالي ~\n✯︙ايدي - ا .\n✯︙رفع مميز - م .\n✯︙رفع ادمن - اد .\n✯︙رفع مدير - مد . \n✯︙رفع منشى - من . \n✯︙رفع منشئ الاساسي - اس  .\n✯︙رفع مطور - مط .\n✯︙رفع مطور ثانوي - ثانوي .\n✯︙تنزيل الكل - تك .\n✯︙تعطيل الايدي بالصوره - تعط .\n✯︙تفعيل الايدي بالصوره - تفع .\n✯︙الرابط - ر .\n✯︙ردود المدير - رر .\n✯︙مسح المكتومين - ،، .\n✯︙اضف رد - رد .\n✯︙مسح سحكاتي - سح .\n✯︙مسح رسائلي - رس .\n✯︙غنيلي - غ .\n✯︙مسح قائمه العام - # .")  
end
--     Source IrAq     --
